// FitSpace — TypeScript Types
// Copy this to /types/index.ts in your Next.js project
...
export interface StylePairing {
  item_type: string        // e.g. "White linen shirt"
  description: string      // e.g. "Loose-fit, untucked, rolled sleeves"
  reasoning: string        // Why it works with the original piece
  search_terms: string[]   // Terms to search our posts DB for inspo
}
